                ...
                >
                    ...
                    <div className="flex-1">
                        ...
                        <p className="truncate text-[14px]">
                            ...
                            elit. Debitis minus saepe nam dolores laborum nisi
                            quas possimus deleniti obcaecati excepturi,
                            accusantium asperiores quibusdam ex odit neque vitae
                            quis laboriosam cumque!
                        </p>
                    </div>
